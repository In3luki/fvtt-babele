...
declare global {
    ...
    class Hooks {
        ...
        static on(...args: HookParamsRender<ActorSheet<Actor<null>>, "ActorSheet">): number;
        static on(...args: HookParamsRender<Compendium<CompendiumDocument>, "Compendium">): number;
